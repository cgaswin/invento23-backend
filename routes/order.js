...
const { createOrder,verifyOrderForProshow, getVerifiedOrdersForAParticularEvent,getAllOrders,getUnverifiedOrders,getVerifiedOrders,getOrdersForEvent ,verifyOrder} = require("../controllers/orderController")
...
router.route("/orders/proshow/verify").post(verifyOrderForProshow)
